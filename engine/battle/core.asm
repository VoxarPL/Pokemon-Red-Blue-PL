...
DrawEnemyHUDAndHPBar:
	...
	and a
	jr z, .notOwned
	coord hl, 1, 1 ; pozycja ikonki złapanego Pokémona
	ld [hl], $e9 ;
	.notOwned
	pop hl
	ld de, wEnemyMonNick
...
.playersTurn
	...
	ld hl, IsUnaffectedText ; UnaffectedText
.gotTextToPrint
	push de
	call PrintText
	xor a
...
.calcHitChance
	...
	ld b, a
.doAccuracyCheck
; the following snippet is taken from Pokemon Crystal, it fixes the bug
	ld a, b
